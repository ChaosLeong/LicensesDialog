...
public class LicensesDialogFragment extends DialogFragment {
    ...
    private static final String ARGUMENT_NOTICE_IS_NIGHT_STYLE = "ARGUMENT_NOTICE_IS_NIGHT_STYLE";
    ...
    private static LicensesDialogFragment newInstance(final Notices notices,
        ...
        args.putBoolean(ARGUMENT_NOTICE_IS_NIGHT_STYLE, isNightStyle);
        ...
        if (savedInstanceState != null) {
            ...
            try {
                ...
                if (arguments != null) {
                    ...
                    isNightText = arguments.getBoolean(ARGUMENT_NOTICE_IS_NIGHT_STYLE);
                } else {
    ...
    public static class Builder {
        ...
        public Builder setIsNightStyle(final boolean isNight) {
            isNightStyle = isNight;
            return this;
        }
        ...
        public LicensesDialogFragment build() {
            if (mNotices != null) {
                return newInstance(mNotices, mShowFullLicenseText, mIncludeOwnLicense, mNoticesStyle, mNoticesNightStyle, isNightStyle, mThemeResourceId, mDividerColor, mUseAppCompat);
            } else if (mRawNoticesResourceId != null) {
                return newInstance(mRawNoticesResourceId, mShowFullLicenseText, mIncludeOwnLicense, mNoticesStyle, mNoticesNightStyle, isNightStyle, mThemeResourceId, mDividerColor, mUseAppCompat);
            } else {
